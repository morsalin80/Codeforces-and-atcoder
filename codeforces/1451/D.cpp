...
void solution(){
    ...
    /*Regardless of what move player 1 makes, player 2 can force the
    token to be at some point on the line x=y at the end of his turn
    (if player 1 moves up, player 2 can move right and vice versa).
    */if(x==y){
        cout << "Utkarsh" << endl;
    }
    else {
